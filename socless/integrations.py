...
class ParameterResolver:
    ...
    def resolve_reference(self, reference_path):
        ...
        if not (reference_path.startswith(VAULT_TOKEN)
...
class ExecutionContext:
        ...
        if not item:
            raise Exception(
                "Error: Unable to get execution_id {} from {}".format(
                    self.execution_id, RESULTS_TABLE))
        return item
    ...
    def save_state_results(self, state_name, result, errors={}):
        ...
        results_table.update_item(
            ...
            UpdateExpression=
            f'SET #results.#results.#name = :r, #results.#results.#last_results = :r {error_expression}',
    ...
    def __init__(self,
        ...
        if self.testing:
            ...
            if self.execution_id:
                ...
                self.context = self.execution_context.fetch_context(
                )['results']
