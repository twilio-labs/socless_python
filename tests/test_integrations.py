...
#         assert self.resolver.resolve_reference("$.artifacts.event.details.middlename") == "Malory"
...
#         state_handler = StateHandler(self.event_testing, MockLambdaContext(), mock_integration_handler)
...
#         state_handler = StateHandler(self.event_testing, MockLambdaContext(), mock_integration_handler)
#         assert state_handler.execute() == self.event_testing['State_Config']['Parameters']
